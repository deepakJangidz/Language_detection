...
model = model.type(torch.cuda.FloatTensor if device.type == 'cuda' else torch.FloatTensor)
...
#     # Step 6: Save our model                                 #
#     ##########################################################
#     torch.save(model.state_dict(), "cnn_model_trained_normal.pt")
#     print("Model has been saved as 'cnn_model_trained_normal.pt'. Use torch.load to load the saved model")
